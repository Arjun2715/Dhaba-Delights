                ...
                <nav>
                    <ul className="flex flex-row space-x-4">
                        <li className="cursor-pointer hover:underline">
                            <Link className="md:font-medium md:text-xl" href="/">Home</Link>
                        </li>
                        <li className="cursor-pointer hover:underlin">
                            <Link className="md:font-medium md:text-xl" href="/shop">Shop</Link>
                        </li>
                        {/* <li className="cursor-pointer">
                            <Link href="/about">About us</Link>
                        </li> */}
                        <li className="cursor-pointer hover:underlin">
                            <Link className="md:font-medium md:text-xl" href="/contact">Contact</Link>
                        </li>
                    </ul>
                </nav>
            </div>
